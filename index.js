...
const unfundedStr = numUnfundedGames === 1 
    ? "1 games remains unfunded. We need your help to fund this amazing game!"
    : `Currently ${numUnfundedGames} games remain unfunded. We need your help to fund these games!`

// create a new DOM element containing the template string and append it to the description container
const unfundedInfo = document.createElement('p');
unfundedInfo.textContent = unfundedStr;
